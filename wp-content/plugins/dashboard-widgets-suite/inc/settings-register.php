...
function dashboard_widgets_suite_register_settings() {
	...
	add_settings_field('null_rate_plugin',     __('Rate Plugin',       'dashboard-widgets-suite'), 'dashboard_widgets_suite_callback_rate',     'dws_options_general', 'settings_general', array('id' => 'null_rate_plugin',     'section' => 'general', 'label' => esc_html__('Show support with a 5-star rating &raquo;', 'dashboard-widgets-suite')));
	add_settings_field('null_show_support',    __('Show Support',      'dashboard-widgets-suite'), 'dashboard_widgets_suite_callback_support',  'dws_options_general', 'settings_general', array('id' => 'null_show_support',    'section' => 'general', 'label' => esc_html__('Show support with a small donation &raquo;', 'dashboard-widgets-suite')));
