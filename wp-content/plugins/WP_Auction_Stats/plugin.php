          ...
          <div id="details" >
            <div id="filter_date" >
              ...
              <?php 
					...
					$item_User = Post_Stats_List::getUserCustomFunc('',$from_vistor,$to,$period);
					
				?>
				<link rel='stylesheet' id='simple_tooltips_style-css' href='/wp-content/plugins/simple-tooltips/zebra_tooltips.css?ver=1679678423' type='text/css' media='all' />
				<script type='text/javascript' src='/wp-content/plugins/simple-tooltips/zebra_tooltips.js?ver=1679678423' id='simple_tooltips_base-js'></script>
				<script type="text/javascript">
                    jQuery(function() {
              ...
              <div class="top_panel top_panel_left">
                <table width="100%" style="margin-top:0;" class="table_bg">
                  <thead>
					 <tr>
						 <th colspan="2">Session&nbsp;&nbsp;<!--<small><a href="javascript:" title="Google Analytics tracks each engagement. Returning after 30 minutes remaining logged in counts as 1 session." style="color: red !important;">(i)</a></small>--><span class="tooltips" title="Google Analytics tracks each engagement. Returning after 30 minutes remaining logged in counts as 1 session."><small style="color: red !important;">(i)</small></span></th>
                    </tr>
                    <tr>
                      <th>Client</th>
                      <th>Dentist</th>
					  <th>Auctions</th>
					  <th>Relists&nbsp;&nbsp;<!--<small ><a href="javascript:" title="1x only discounted 2nd runs" style="color: red !important;">(i)</a></small>--><span class="tooltips" title="1x only discounted 2nd runs"><small style="color: red !important;">(i)</small></span></th>
                      <th>Success</th>
                    </tr>
                  </thead>
                  <tbody >
