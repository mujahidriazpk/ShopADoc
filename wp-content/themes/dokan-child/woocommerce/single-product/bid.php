...
<!--<p class="auction-user mobile_hide"><a href="javascript:"  class="detail_link1">Details</a></p>-->
  <div class="accordion_div1" style="margin-top:5px;">
...
<?php if(($product->is_closed() === FALSE ) && ($product->is_started() === TRUE )){
    ...
    <?php if($_auction_dates_extend == 'yes' && $_auction_extend_counter == 'no'){
			...
			if($_flash_status == 'yes'){
				...
				$auction_status = '<style>@media only screen and (min-width: 850px) {.mejs-pause > button,.mejs-play > button {top: -10px;right: 100px;}.mejs-horizontal-volume-slider {margin-top: -10px !important;margin-right: 35px;}}@media only screen and (max-width: 448px) {.mejs-pause > button,.mejs-play > button {top: -12px;right: 12px;}}</style><span id="auction_status"><span class="no_translate">Flash Bid Cycle<span class="TM_flash">®</span></span> live</span>';
			}else{
	...
	//CountDown();
      	...
      	<div class="auction_detail <?php echo $auction_detail_class?>">
			...
			.jconfirm .jconfirm-box div.jconfirm-content-pane{max-height:unset !important;}
			/*.jconfirm.jconfirm-white .jconfirm-bg, .jconfirm.jconfirm-light .jconfirm-bg{
						...
						if (timetext == 'Pause') {
							...
							jQuery.confirm({
								...
								onContentReady: function () {
										...
										//jQuery(".playBtnContainer").append('<div class="jconfirm-bg blurBg" style="transition-duration: 0.4s; transition-timing-function: cubic-bezier(0.36, 0.55, 0.19, 1);"></div>');
