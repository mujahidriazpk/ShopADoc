...
<div style="margin-bottom: 40px;margin-top: 0;">
  ...
  <table width="100%" border="1">
    ...
    <tr>
      <td style="color:#000;"><?php echo str_replace("(","",str_replace(") ","-",$dentist_cell_ph));?></td>
      <td><a href="tel:<?php echo str_replace("(","",str_replace(") ","-",$client_cell_ph));?>" style="text-decoration:none;"><?php echo str_replace("(","",str_replace(") ","-",$client_cell_ph));?></a></td>
    </tr>
    <tr>
      <td><a style="color:#000;text-decoration:none;" ><?php echo $user_email;?></a></td>
      <td><a style="text-decoration:none;" href="mailto:<?php echo $client_email;?>"><?php echo $client_email;?></a></td>
    </tr>
  </table>
  <table width="100%" border="0">
    <tr>
