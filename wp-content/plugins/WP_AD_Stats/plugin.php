              ...
              <tr>
                <td align="right"><form method="get" id="period-form" action="<?php echo home_url('/wp-admin/admin.php?page=AD_Stats');?>">
                    ...
                    <label>
                      ...
                      :&nbsp;</label>
                    <select id="period" name="period" class="advads-stats-period" onchange="selectDateField();" style="min-height: 35px !important;">
		...
		jQuery('input[name="check_box_print"]').click(function(){ 
			...
			<style type="text/css">
				@media print {
					...
					.widefat td, .widefat thead th, .row-title, .row-actions{font-size: 17px !important;border-bottom: 2px solid #dddddd;color: #444 !important;}
					@page 
					{
						size: auto;   
						margin: 0mm; 
                  ...
                  <table class="wp-list-table widefat fixed striped table-view-list posts">
                    <thead style="width: 100%;">
                      <tr>
                        ...
                        <th scope="col" align="left"  style="text-align:left !important;" width="37%"><span>Creative <span class="not_print"><img src="<?php echo home_url('/wp-content/uploads/2021/10/Darker_Green.jpg');?>" style="height:26px;">&nbsp;&nbsp;&nbsp;Company&nbsp;&nbsp;&nbsp;Run Period</span></span></th>
                    ...
                    <tbody id="the-list">
                      ...
                      <tr class="content not_print" id="row_<?php echo $ad->ID;?>">
                        ...
                        <td class="post-status" style="text-align: left !important;" width="37%"><img src="<?php echo $image_url;?>" alt=""  width="" height="26px" />&nbsp;<br class="print_only"><?php echo $post_title;?></td>
                      ...
                      <?php } ?>
						<tr >
							<td colspan="6" class="print_only" align="left" style="text-align:left !important;"><img src="<?php echo home_url('/wp-content/themes/dokan-child/google_by_logo.png');?>" alt="google_data_logo" style="width:195px;margin-left:-8px;">
							</td>
						</tr>
						<tr style="background-color: #000 !important;color:#fff !important;">
							<td colspan="6" class="print_only" align="left" style="text-align:left !important;color:#fff !important;font-weight: normal !important;">© 2018-2022 ShopADoc Inc. All Rights Reserved
							</td>
						</tr>
                      <?php } else { ?>
                      <tr >
